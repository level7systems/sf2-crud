...
use Demo\UserBundle\Form\UserFilterType;
...
class UserController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('DemoUserBundle:User')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("DemoUserBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DemoUserBundle:User')->find($id);
     ...
     * @Method("PUT")
     * @Template("DemoUserBundle:User:edit.html.twig")
     */
